...
namespace AyBorg.Communication.gRPC.Tests;
...
public class RpcMapperTests
{
    ...
    public void Test_FromRpc_StepDto()
    {
        ...
        // Act
        StepModel result = _service.FromRpc(dto);
    ...
    public void Test_ToRpc_Step()
    {
        ...
        step.Ports = step.Ports!.Append(new PortModel
        {
            Id = Guid.NewGuid(),
            Name = "Test_Port",
    ...
    public void Test_FromRpc_PluginMetaDto()
    {
        ...
        // Act
        PluginMetaInfo result = _service.FromRpc(dto);
    ...
    public void Test_FromRpc_LinkDto()
    {
        ...
        // Act
        LinkModel result = _service.FromRpc(dto);
    ...
    public void Test_FromRpc_PortDto(PortBrand portBrand, string value)
    {
        ...
        // Act
        PortModel result = _service.FromRpc(dto);
        ...
        {
            Assert.Equal("Output", ((EnumModel)result.Value!).Name);
            return;
        }
        ...
        {
            Assert.Equal(2, ((RectangleModel)result.Value!).X);
            Assert.Equal(4, ((RectangleModel)result.Value!).Y);
            Assert.Equal(10, ((RectangleModel)result.Value!).Width);
            Assert.Equal(20, ((RectangleModel)result.Value!).Height);
            return;
        }
    ...
    public void Test_DoublePortFromRpc(double expectedValue, string value)
    {
        ...
        // Act
        PortModel port = _service.FromRpc(dto);
